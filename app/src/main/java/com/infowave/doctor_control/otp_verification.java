...
public class otp_verification extends AppCompatActivity {
    ...
    private static final String VERIFY_OTP_URL = ApiConfig.endpoint("Doctors/verify_otp.php"); // API URL for doctors
    ...
    private void resendOtp() {
        ...
        String URL = ApiConfig.endpoint("Doctors/login.php");  // Your API URL to resend OTP
